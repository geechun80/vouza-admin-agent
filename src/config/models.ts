...
export const AI_MODELS: AIModelInfo[] = [
  ...
  // ─── OpenRouter ── Fast Tier (cheap, simple tasks) ──────────────────────
  {
    ...
    provider: "openrouter",
    description: "FREE — no credits needed. Simple queries, yes/no, status checks. Rate-limited.",
    contextWindow: 128000,
    maxOutput: 4096,
    recommended: true,
    tier: "fast",
  ...
  // ─── OpenRouter — Flagship Tier (complex tasks, analysis, vision) ─────────
  {
    ...
    displayName: "Gemini 2.5 Flash",
    provider: "openrouter",
    description: "Default flagship tier — multimodal (text/image/PDF), 1M context, strong reasoning, reliable availability",
    contextWindow: 1000000,
    maxOutput: 16384,
    recommended: true,
    recommendedReason: "Best flagship for OpenRouter — 1M context, full multimodal, widely available, ideal for complex agentic workflows",
    tier: "flagship",
    pricing: { input: 0.15, output: 0.6 },
    supportsTools: true,
    supportsVision: true,
  ...
  },
  {
    ...
    provider: "openrouter",
    description: "Next-gen Gemini preview — multimodal, reasoning levels, low-cost agentic (may require credits)",
    contextWindow: 1000000,
    maxOutput: 16384,
    recommended: false,
    tier: "flagship",
